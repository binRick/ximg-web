...
| [ironfist.ximg.app](https://ironfist.ximg.app) | Iron Fist 3D — Duke Nukem-style FPS built from scratch in C with raylib. Single game.c, 3 weapons, chef enemies, Q3 platforms, custom GLSL lighting. |
