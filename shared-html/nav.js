(function () {
  ...
  var GROUPS = [
    { label: 'Tech', apps: [
      ...
      ['c99','c99'],['cdn','cdn'],['golang','golang'],['chmod','chmod'],['clamav','clamav'],['claude','claude'],['computers','computers'],['crypto','crypto'],['database','database'],['dns','dns'],['docker','docker'],
      ['embeddings','embeddings'],['gentoo','gentoo'],['git','git'],['http','http'],['internet','internet'],['iptables','iptables'],['json','json'],['linux','linux'],['loadbalancer','loadbalancer'],['mac','mac'],['makefile','makefile'],['network','network'],['nodejs','nodejs'],['os','os'],['passwords','passwords'],['php','php'],['playground','playground'],['programming','programming'],['python','python'],['queue','queue'],['raylib','raylib'],['request','request'],['security','security'],['smtp','smtp'],['sql','sql'],['ssh','ssh'],['suricata','suricata'],['systemd','systemd'],['systemdesign','systemdesign'],['temperature','temp'],['tls','tls'],['tmux','tmux'],['tokens','tokens'],['unix','unix'],['utf8','utf8'],['vim','vim'],['vr','vr'],['vt101','vt101'],['yaml','yaml'],['zsh','zsh']
    ]},
    { label: 'Culture', apps: [
    ...
    { label: 'Retro', apps: [
      ['arpanet','arpanet'],['bbs','BBS'],['commodore','commodore'],['conway','conway'],['dos','DOS'],['fidonet','fidonet'],['mainframe','mainframe'],['modem','modem'],['punch','punch card'],['templeos','TempleOS'],['terminal','terminal'],
    ]},
    { label: 'Food', apps: [
